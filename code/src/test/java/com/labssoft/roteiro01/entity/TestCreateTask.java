...
public class TestCreateTask {
    ...
    void shoul_not_be_able_to_create_task_with_title_outside_limits(String title){
        try {
            ...
            assertEquals("Título da tarefa deve possuir pelo menos 1 caractere e no máximo 100 caracteres", e.getMessage());
        }
    }
    ...
    void should_not_be_able_to_create_task_with_description_outside_limits(){
        try {
            new Task("Título", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus quis tellus in turpis dapibus nulla.");
        } catch (Exception e) {
