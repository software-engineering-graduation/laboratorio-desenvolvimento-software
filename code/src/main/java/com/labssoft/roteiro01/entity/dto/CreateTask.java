...
public class CreateTask{
    ...
    @Schema(
        description = "Caso a tarefa seja do tipo Date, informar a data de vencimento maior que a data atual.",
        example = "05/04/2024"
    )
    private Date dueDate;

    @Schema(
        description = "Caso a tarefa seja do tipo Period, informar a quantidade de dias para vencimento.",
        example = "5"
    )
